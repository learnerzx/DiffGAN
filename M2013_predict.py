...
if __name__ == "__main__":
    ...
    #     mask_func = Gaussian2DMaskFunc(accelerations=args.accelerations, center_fractions=args.center_fractions)
    # elif args.mask_type == 'Radial':
    #     mask_func = RadialMaskFunc(accelerations=args.accelerations,center_fractions=args.center_fractions)
    # elif args.mask_type == 'Spiral':
    #     mask_func = SpiralMaskFunc(accelerations=args.accelerations,center_fractions=args.center_fractions)
    # elif args.mask_type == 'Poisson':
    #     mask_func = VariableDensityPoissonMaskFunc(accelerations=args.accelerations,center_fractions=args.center_fractions)
    # elif args.mask_type == 'Random':
    #     mask_func = FastMRIRandomMaskFunc(accelerations=args.accelerations,center_fractions=args.center_fractions)
    # else:
    ...
    # masks = mask_func([256, 256, 1], seed=args.seed)
    # masks = masks.numpy()
    #
    # masks = np.append(masks, masks, axis=0).squeeze()
    #
    # maskNot = 1 - masks
    ...
    print("avg_inference_time:{:.4}".format(np.mean(total_mean_time)))
